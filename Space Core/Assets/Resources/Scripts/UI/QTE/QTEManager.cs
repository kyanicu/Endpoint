...
public abstract class QTEManager : MonoBehaviour
{
    ...
    protected QTEButton activeButton;

    //Our stack of QTE buttons
    protected List<QTEButton> buttonStack = new List<QTEButton>();
    ...
    protected IEnumerator Listener()
    {
    ...
    /// Runs different functionality based on inherited object
    /// </summary>
<<<<<<< HEAD:Space Core/Assets/Resources/Scripts/UI/QTE/Base/QTEManager.cs
    public abstract void successfulHack();
=======
...
>>>>>>> 2f6d9b00abb4d75f634655ee7111d4f1c2f6abd2:Space Core/Assets/Resources/Scripts/UI/QTE/QTEManager.cs
}