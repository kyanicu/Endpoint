Shader "Unlit/ShieldFX"
{
	Properties
	{
		//Main color of the bump
		_MainColor("MainColor", Color) = (1,1,1,1)

		//Main texture set to white
		_MainTex ("Texture", 2D) = "white" {}

		//Set brightness of shader color
		_Fresnel("Fresnel Intensity", Range(0,200)) = 3.0

		//Set distance of texture from edge to center
		_FresnelWidth("Fresnel Width", Range(0,2)) = 3.0

		//Set bump map visiblity
		_Distort("Distort", Range(0, 100)) = 1.0

		//Set reflection brightness when in proximity of camera
